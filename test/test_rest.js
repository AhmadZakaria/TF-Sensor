...
const config = require(path.join(__dirname, "../_sensors-project/sensor-server/config", "start.json"));
const pkg = require(path.join(__dirname, "../package.json"));
let app;
process.title = pkg.name;
config.basedir = __dirname + "/../_sensors-project/sensor-server";
...
if (cluster.isMaster && !module.parent.parent)
    ...
    app = new(require("sensor-server/lib/DefaultApp"))(cluster.Worker(), pkg, config);
}
